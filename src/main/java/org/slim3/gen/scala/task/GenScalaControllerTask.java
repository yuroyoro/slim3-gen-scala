...
import org.slim3.gen.scala.generator.ScalaControllerGenerator;
import org.slim3.gen.scala.generator.ScalaControllerTestCaseGenerator;
 ...
 * 
 */
public class GenScalaControllerTask extends AbstractGenScalaFileTask {
    ...
    public void doExecute() throws Exception {
        ...
        ScalaFile scalaFile = createScalaFile(controllerDesc);
        Generator generator = createControllerGenerator(controllerDesc);
        generateScalaFile(generator, scalaFile);

        ScalaFile testCaseScalaFile = createTestCaseScalaFile(controllerDesc);
    ...
    protected Generator createControllerGenerator(ControllerDesc controllerDesc) {
        return new ScalaControllerGenerator(controllerDesc);
    }
    ...
    protected Generator createControllerTestCaseGenerator(
        ...
        return new ScalaControllerTestCaseGenerator(controllerDesc);
    }
